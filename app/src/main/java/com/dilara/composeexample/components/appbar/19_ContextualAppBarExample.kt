...
fun ContextualAppBarExample(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("This example shows a Contextual AppBar with:")
            Spacer(modifier = Modifier.height(8.dp))
            Text("• Context-based appearance")
            Text("• Selection mode toggle")
            Text("• Dynamic action buttons")
...
@Composable
fun ContextualAppBarExamplePreview() {
    ContextualAppBarExample()
}
