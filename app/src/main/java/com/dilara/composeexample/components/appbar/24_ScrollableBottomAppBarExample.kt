...
@Composable
fun ScrollableBottomAppBarExample(
    onBackClick: () -> Unit = {}
) {
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                Text(
                    "This example shows a Scrollable Bottom AppBar with:",
...
@Composable
fun ScrollableBottomAppBarExamplePreview() {
    ScrollableBottomAppBarExample()
} 